                        ...
                        <tbody>
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a class="me-3" href="{{ route('admin.category.edit', $row) }}">
                                            <i class="fe fe-edit-3" data-bs-toggle="tooltip" title="Edit category"></i>
                                        </a>
                                        <div>
                                            <form method="post" action="{{ route('admin.category.destroy', $row) }}"
