                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            ...
                                            <input type="checkbox" id="{{$size->id}}" class="check">
                                            <label for="{{$size->id}}" class="checktoggle">checkbox</label>
                                        </div>
                                    </td>
                                    <td class="d-flex">
                                        <a class="me-3" href="{{ route('admin.size.edit', $size) }}">
                                            <i class="fe fe-edit-3" data-bs-toggle="tooltip" title="Edit Size"></i>
                                        </a>
                                        <div>
                                            <form method="post" action="{{ route('admin.size.destroy', $size) }}"
