...
@section('content')
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('admin.section.create') }}" class="btn btn-added">
                    <img src="{{ asset('assets/img/icons/plus.svg') }}" class="me-1" alt="img">Add Section
                </a>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td>{{ $row->name }}</td>
                                    <td class="d-flex">
                                        <a class="me-3" href="{{ route('admin.section.edit', $row) }}">
                                            <i class="fe fe-edit-3" data-bs-toggle="tooltip" title="Edit"></i>
                                        </a>
                                        <div>
                                            <form method="post" action="{{ route('admin.section.destroy', $row) }}"
