...
@section('content')
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('admin.color.create') }}" class="btn btn-added">
                    <img src="{{ asset('assets/img/icons/plus.svg') }}" class="me-1" alt="img">Add Color
                </a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="status-toggle d-flex justify-content-between align-items-center">
                                            <input type="checkbox" id="{{ $row->id }}" class="check">
                                            <label for="{{ $row->id }}" class="checktoggle">checkbox</label>
                                        </div>
                                    </td>
                                    <td class="d-flex">
                                        {{-- <a class="me-3" href="{{ route('admin.color.edit', $row) }}">
                                            <i class="fe fe-edit-3" data-bs-toggle="tooltip" title="Edit Color"></i>
                                        </a> --}}
                                        <div>
                                            <form method="post" action="{{ route('admin.color.destroy', $row) }}"
